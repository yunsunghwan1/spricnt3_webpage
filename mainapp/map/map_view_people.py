...
class Map_View :
    ...
    def __init__(self, input_data) :
        self.initDataFrame()
        self.map_base()
        self.map_location(input_data)


    ### 데이터 읽어들이기
    def initDataFrame(self) :
        file_path = "./mainapp/map/locpeople_df.csv"
        # self.seoul_starbucks = pd.read_csv(file_path, encoding=)
        self.local_population = pd.read_csv(file_path, encoding='cp949')
